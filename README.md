...
- **React** : 재사용 가능한 UI 구성 요소를 만들고 컴포넌트를 조립하여 개발하는 방식은 유지보수하기에 유리하다고 생각하였습다. JSX 문법을 사용하여 더 쉽고 빠르게 개발을 할 수 있었습니다.
